...
def predict():
    ...
    API_KEY = "6r0_wnJFuPBQm-nVwrNtIaC8211lRAiSLVnzQVgYyJjy"
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/557d49b8-56ab-40d3-8c98-2ae36381072f/predictions?version=2022-06-24', json=payload_scoring,
